...
public class DagFindShortestPathTest {
    ...
    private static Stream<Arguments> input() {
        return Stream.of(
                ...
                Arguments.of(dag, Map.of("from", 0, "to", 10), List.of(new Edge(0, 2, 1.0), new Edge(2, 8, 1.0), new Edge(8, 10, 1.0))),
                Arguments.of(weightedDag, Map.of("from", 1, "to", 3), List.of(new Edge(1, 3, 1.0))),
                Arguments.of(weightedDag, Map.of("from", 0, "to", 3), List.of(new Edge(0, 2, 1.0), new Edge(2, 5, 1.0), new Edge(5, 3, 1.0)))
        );
    }
    ...
    public void executeTask_success() {
        ...
        //when
        TaskResult result = TaskDefinition.FIND_SHORTEST_PATH_DAG.execute(graph, config, params);
